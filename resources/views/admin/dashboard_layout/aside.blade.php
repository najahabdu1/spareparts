...
<section class="sidebar">
        ...
        <div class="ulogo">
                ...
                <!-- logo for regular state and mobile devices -->
                    <div class="d-flex align-items-center justify-content-center">
                        ...
                        <h3><b>Spare Parts Store</b> Admin</h3>
                    </div>
            </a>
        </div>
    </div>
    ...
    <li class="treeview {{ Request::is('admin/orders*') ? 'active' : '' }}">
        ...
        <ul class="treeview-menu">
            ...
            <li class=" {{ Request::is('admin/order/delivered*') ? 'active' : '' }}">
                <a href="{{ route('return.orders') }}"><i class="ti-more"></i>Returned Orders</a>
            </li>
             <li class=" {{ Request::is('admin/order/delivered*') ? 'active' : '' }}">
                <a href="{{ route('cancel.orders') }}"><i class="ti-more"></i>Cancel Request Order</a>
            </li>
        </ul>
    </li>
