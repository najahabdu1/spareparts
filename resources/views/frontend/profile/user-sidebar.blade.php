<div class="col-md-2">
    ...
    <ul class="list-group list-group-flush">
        ...
        <a href="{{ route('user.return-orders') }}" class="btn btn-primary btn-sm btn-block">Return Confirmed Orders</a>
        <a href="{{ route('user.cancel-orders') }}" class="btn btn-primary btn-sm btn-block">Return Requested Orders</a>
